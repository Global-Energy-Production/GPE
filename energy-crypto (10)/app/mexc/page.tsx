...
export default async function MexcPage() {
  const dict = await getDictionary()
  const mexcUrl = "https://www.mexc.com/dex"

  // Garantir que dict.pages.mexc existe
  const pageDict = dict.pages?.mexc || {
    title: "MEXC Exchange",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-900 rounded-xl p-8 shadow-lg border border-yellow-500/20">
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-yellow-500/10 mb-8">
              <h3 className="text-lg font-medium text-gray-300 mb-4">MEXC Exchange Chart</h3>
